...
const timeline = [
  ...
  },
  {
    id: 2,
    content: "Front End ",
    target: "HTML, CSS, Javascript, React.js, Next.js",
    href: "#",
...
export default function Portfolio() {
  const scrollToSection = (targetId) => {
    ...
    if (target) {
      target.scrollIntoView({ behavior: "smooth", block: "center" }); // Scroll to the top of the section
    }
  };
    ...
    <div className="bg-white">
      ...
      <header className=" absolute inset-x-0 top-0 z-50">
        ...
        >
          ...
          <div className="lg:flex lg:gap-x-12 items-center w-full justify-center ">
            {navigation.map((item) => (
              <a
                key={item.name}
                href={item.href}
      ...
      <main>
        ...
        >
          ...
          <div className="mt-6 mx-auto max-w-7xl px-6  lg:flex lg:items-center lg:gap-x-10 lg:px-8 ">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
              <div className="flex">
                <div className="relative flex items-center gap-x-4 rounded-full px-4  text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              ...
              <div className="mt-7 block items-center gap-x-6">
                <a
                  href="/Naveen Kumar's CV.pdf"
                  download="Naveen Kumar's CV"
            ...
            <div className="mt-16 sm:mt-24 lg:mt-0 lg:flex-shrink-0 lg:flex-grow">
              <svg
                ...
                height="600px" // Adjust the height of the SVG
              >
              ...
              <figure className="relative isolate pt-6 sm:pt-12">
                ...
                <blockquote className="text-xl font-semibold leading-8 text-white sm:text-2xl sm:leading-9">
                  <p>
                    ...
                    or if you simply want to connect and share insights, I'd
                    love to hear from you. Let's collaborate and build something
                ...
                <a
                  href="https://www.linkedin.com/in/naveen-kumar-87997a198/"
                  className="mt-8 flex justify-center items-center mx-auto w-max  bg-blue-500 px-10 py-4  rounded-lg "
                >
                  <LiaLinkedin size={25} />
                  LinkedIn
                </a>
